            ...
            <CardContent className="p-6">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className={`cursor-pointer rounded-lg p-4 transition-all relative ${selection === 'rep-only' ? 'border-2 border-primary/[0.02] bg-primary/5' : 'border border-primary/[0.01] hover:border-primary/50'}`} onClick={() => handleSelectionChange('rep-only')}>
                ...
                <div className="space-y-3">
                  ...
                  <div className={`cursor-pointer rounded-lg p-4 transition-all relative ${selection === 'all-three' ? 'border-2 border-primary/[0.02] bg-primary/5' : 'border border-primary/[0.01] hover:border-primary/50'}`} onClick={() => handleSelectionChange('all-three')}>
